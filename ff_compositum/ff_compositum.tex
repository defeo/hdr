...
\newenvironment{algorithm_noendline}[4]{\small\begin{center}\begin{minipage}{0.98\textwidth}
      \refstepcounter{algo}
...
\newenvironment{algorithm_endline}[4]{\small\begin{center}\begin{minipage}{0.98\textwidth}
      \refstepcounter{algo}
      \label{ff_compositum:#4}
      \sf
      \rule{\textwidth}{0.2pt}\\
