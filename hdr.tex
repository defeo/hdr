...
made by Serre, Tate, and, obviously, Grothendieck. %
...
system~\cite{todo}, and then adopted by Magma~\cite{MAGMA} and
SageMath~\cite{Sage}. %
...
families: the first one, due to Lenstra~\cite{todo} and
Allombert~\cite{todo}, based on the theory of Kummer extensions; the
second one, due to Pinch~\cite{todo} and Rains~\cite{todo}, based on
Gaussian periods. %
...
- Representing extensions: multivariate, univariate, triangular sets,
change of order, rur, etc.
...
\emph{Montgomery ladders}~\cite{cryptoeprint:2017:1015}, and various
software and hardware level
optimizations~\cite{cryptoeprint:2017:1213}. %
...
% LocalWords:  cryptosystem instantiations dihedral cryptology
% LocalWords:  cyclotomic
